...
create or replace package body ut_deathstar_add_rooms as
  ...
  as
    ...
    begin
      ...
      open c_expect for
      	select 43 id , 'Testroom 1' name                   , 'TEST1' code , -1 section_id , 1 nr_in_section  from dual union all
        select 44    , 'Testroom 2'                        , 'TEST2'      , -1            , 2                from dual union all
        select 45    , 'Testroom 3'                        , 'TEST3'      , -2            , 1                from dual union all
        select 46    , 'Testroom 4 - NULL code'            , 'TESTRO1'    , -1            , 3                from dual union all
        select 47    , 'Testroom 5 - how will the code be' , 'TESTRO2'    , -1            , 4                from dual union all
        select 48    , 'Testroom 6 - Section 2'            , 'TESTRO3'    , -2            , 2                from dual
      ;
